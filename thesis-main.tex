...
\chapter{Background}
\section{Introduction to AI Fariness}
...
\begin{itemize}
    ...
    \item \textbf{Bias in Evaluation:} If we evaluate models using metrics that don't account for fairness considerations, we might deploy systems that appear successful but discriminate in practice.
